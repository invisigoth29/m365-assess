...
export function normalizeSeverity(severity) {
  ...
  // ScubaGear Criticality mapping
  if (lower === 'shall' || lower.includes('shall')) return 'high';
  if (lower === 'should' || lower.includes('should')) return 'medium';
  if (lower === 'may' || lower.includes('may')) return 'low';
  if (lower.includes('3rd party') || lower.includes('third party')) return 'low';
  if (lower.includes('not-implemented')) return 'info';
